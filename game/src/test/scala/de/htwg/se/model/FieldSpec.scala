...
class FieldSpec extends AnyWordSpec {
    "A Mastermind Field" when {
        "filled with W" should {
            ...
            "have cells as String of form '| W | W | W | W | W |'" in {
                field2.cells(0) should be("| W | W | W | W | W |" + eol)
            }
            "have a mesh in the form " +
                "+---+" +
                "| W |" +
                "+---+" in {
                    field3.mesh(1) should be("+---+" + eol + "| W |" + eol + "+---+" + eol)
                    field4.mesh(1) should be("+---+" + eol + "| W |" + eol + "+---+" + eol + "| W |" + eol + "+---+" + eol + "| W |" + eol + "+---+" + eol)
                }
        }
        "filled with B" should {
            ...
            "have cells as String of form '| B | B | B | B | B |'" in {
                field2.cells(0) should be("| B | B | B | B | B |" + eol)
            }
            "have a mesh in the form " +
                "+---+" +
                "| B |" +
                "+---+" in {
                    field3.mesh(1) should be("+---+" + eol + "| B |" + eol + "+---+" + eol)
                    field4.mesh(1) should be("+---+" + eol + "| B |" + eol + "+---+" + eol + "| B |" + eol + "+---+" + eol + "| B |" + eol + "+---+" + eol)
                }
        }
